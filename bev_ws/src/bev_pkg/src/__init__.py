...
RGB_BY_MASK = {
    BirdViewMasks.EGOPASTTRAJECTORY: RGB.RED,
    BirdViewMasks.EGOTRAJECTORY: RGB.CHAMELEON,
...
class BirdViewProducer:
    ...
    def produce(self, agent_vehicle: carla.Actor, trajectory: carla.Location, count) -> BirdView:
        ...
        # print("{}".format(agent_vehicle_loc))
        ...
        # ego trajectory to carla.location
        # if count == 0:
        # for traj in trajectory:
        #     print("{}".format(traj))

        #     agent_global_px_traj = self.masks_generator.location_to_pixel(traj)
        ...
        masks = self._render_actors_masks(agent_vehicle, trajectory, segregated_actors, masks)
